        ...
        <div className={"flex flex-col grow  my-4 giph-list " + (props.model.isLoading ? "giph-list-disabled" : "")}>
            ...
            <div
                ...
                {props.model.isLoading && (
                    <div className="flex flex-col grow justify-center items-center my-2 light-gray">
                        <span className="giphy-explorer text-center text-wrap fw-bold mb-4">loading</span>
                        <EllipsisHorizontalIcon className="giphy-explorer-image"></EllipsisHorizontalIcon>
                    </div>
                )}
            </div>
        </div>
